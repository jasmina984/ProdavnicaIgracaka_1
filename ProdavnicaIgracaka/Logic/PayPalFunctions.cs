...
public class NVPAPICaller
{
    ...
    public string APIUsername = "korolijavukan-facilitator_api1.gmail.com";
    private string APIPassword = "NVJXQ33BKVWWLMTC";
    private string APISignature = "AR6jfZ-xy9rVRwbk5sa6I.SAgPkdA.J1niuNJKtiSFgRs22TxZ3NWq4O";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (ProdavnicaIgracaka.Logic.ShoppingCartActions myCartOrders = new ProdavnicaIgracaka.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        catch (Exception)
        {
            ...
            // Log the exception.
            // ProdavnicaIgracaka.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
