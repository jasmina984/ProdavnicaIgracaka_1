    ...
    public partial class SiteMaster : MasterPage
    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            using (ShoppingCartActions usersShoppingCart = new ShoppingCartActions())
            {
                ...
                // Vraćena vrednost se dodaje u oznaku cartCount koja je uključena u označavanje stranice Site.Master. 
                cartCount.InnerText = cartStr;
            }
        }
        //Tagovi <span> omogućavaju da se unutrašnji elementi ispravno prikazuju. 
        //Kada se prikaže bilo koja stranica sajta, prikazaće se total korpe. 
