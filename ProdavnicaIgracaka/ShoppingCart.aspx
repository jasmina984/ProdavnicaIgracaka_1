...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="ShoppingCartTitle" runat="server" class="ContentHead"><h1>Korpa za kupovinu</h1></div>
    <asp:GridView ID="CartList" runat="server" AutoGenerateColumns="false" ShowFooter="True" GridLines="Vertical" CellPadding="4" ItemType="ProdavnicaIgracaka.Models.CartItem" SelectMethod="GetShoppingCartItems" CssClass="table table-striped table-bordered">
            <Columns>
                <asp:BoundField DataField="ProductID" HeaderText="Sifra artikla" SortExpression="ProductID" />
                ...
                <asp:TemplateField HeaderText="Izbrisite">
                    <ItemTemplate>
    ...
    <table>
        <tr>
            <td>
                <asp:Button ID="UpdateBtn" runat="server" Text="Azuriranje" OnClick="UpdateBtn_Click" />
            </td>
            <td>
